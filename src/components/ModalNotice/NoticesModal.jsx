...
export const NoticeCategoryItem = ({ notice }) => {
  ...
  return (
    <Item>
      ...
      <CommonModal isOpened={true} isActionsDisabled={false} closeModal={() => setIsModalOpened(false)}>
        <TabWraper>
          <ModalImgWraper>
          ...
          <TitleContentWraper>
            ...
            <ModalContentWraper>
              ...
              <ModalParagtaph>
                <NoticeWraper>The sex:</NoticeWraper> <ModalPetInfoWraper>{'sex'}</ModalPetInfoWraper>
              </ModalParagtaph>
              <ModalParagtaph>
                <NoticeWraper>Email:</NoticeWraper> <ModalPetInfoWraper>{'email'}</ModalPetInfoWraper>
              </ModalParagtaph>
              <ModalParagtaph>
        ...
        <Comments>
          <CommentsWraper>Comments:</CommentsWraper>Lorem ipsum dolor sit amet, consectetur Lorem ipsum dolor sit amet, consectetur Lorem ipsum dolor
